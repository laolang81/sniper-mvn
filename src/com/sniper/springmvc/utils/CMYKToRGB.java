...
public class CMYKToRGB {
	...
	public void readImage(String filename) throws IOException {
		...
		if ("JPEG".equalsIgnoreCase(format) || "JPG".equalsIgnoreCase(format)) {
			...
			// String newfilename =
			// filename.substring(0,filename.lastIndexOf("."))+"_rgb"+filename.substring(filename.lastIndexOf("."));
	...
	public static void main(String[] args) throws IOException {
		String filename = "/home/sniper/图片/2015070618434646757.jpg";
		CMYKToRGB cm = new CMYKToRGB();
