...
<ul id="layer-photos" class="material_manage">
	<#if lists??>
	<#list lists as f>
	<li id="sl_${f.aid}" data-type="${f.filetype}">
	<#if f.isimage == 1>
	...
	<#else>
		<img title="${f.atTime?string("yyyy-MM-dd")}" layer-pid="${f.aid }" layer-src="myfiles/images/webicon/attach_64.png"
				 src="myfiles/images/webicon/attach_64.png" alt="${f.prefilename!''}"/>
	</#if>
	<p> 
    ...
    <p>
	    ...
	    <#if f.sid?? && f.sid gt 0 >
	     <a href="${baseHref.webUrl }/public/html/news/201702/${f.sid}.html" target="_blank">(<i class="fa fa-eye"></i>查看)</a>
	     </#if>
	</p>
