<div id="sniper_menu" class="btn-group" data-spy="affix" data-offset-top="10" style="z-index:100">
	<div class="btn-group">
	...
	<div class="btn-group">
		<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
		${sniperMenu.getKeyValue(oper)} <span class="caret"></span>
  		</button>
...
<!-- 调用 -->
<script type="text/javascript" src="${baseHref.baseHref }myfiles/js/jquery.sniper.menu.js"></script>
