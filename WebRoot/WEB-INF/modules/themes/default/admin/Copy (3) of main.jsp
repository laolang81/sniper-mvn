		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-buttons navbar-header pull-right"
				...
				<ul class="nav ace-nav">
					...
					<li class="purple"><a
						href=".${baseHref.adminPath }/admin-post/audit"> <i
							class="ace-icon fa fa-newspaper-o icon-animated-bell"></i> <span
							class="badge badge-important sniperPost">0</span>
					</a></li>
					<li class="green"><a
						href=".${baseHref.adminPath }/admin-comment/"> <i
	...
	<div class="main-container" id="main-container">
		...
		<div id="sidebar" class="sidebar responsive">
			...
			<ul class="nav nav-list" style="margin-top:1px;">
				...
				<c:if test="${menuDeps != null }">
					<li class="" id="menuSub_0"><a
						href=".${baseHref.adminPath }/admin-post/#"
						class="dropdown-toggle"> <i
							class="menu-icon fa fa-newspaper-o"></i> <span class="menu-text">
								新闻添加</span> <b class="arrow fa fa-angle-down"></b>
					</a> <b class="arrow"></b>
						<ul class="submenu nav-show">
							<c:forEach items="${menuDeps }" var="d">
								<li class="" id="menuSub_${d.key }"><a
									href=".${baseHref.adminPath }/admin-post/#"
									class="dropdown-toggle"> <i
										class="menu-icon fa fa-caret-right"></i> <span
										class="menu-text">${d.value }</span> <b
										class="arrow fa fa-angle-down"></b>
								</a> <b class="arrow"></b>
									<ul class="submenu">
										<c:if test="${menuItems != null && menuItems[d.key] != null }">
											<c:forEach items="${menuItems[d.key] }" var="i">
												<li class="" id="menuSub_item_${i.key }"><a
													href=".${baseHref.adminPath }/admin-post/insert?id=${i.key}">
														<i class="menu-icon fa fa-caret-right"></i> ${i.value.name }
