<%@ page import="com.sniper.springmvc.webSocketConfig.Constants"%>
  ...
  <script type="text/javascript">
    ...
    function echo() {
      if (ws != null) {
        ...
        log('<%=session.getAttribute(Constants.SESSION_USERNAME)%>：' + message);
        ws.send(message);
      } else {
        alert('没有建立连接，请连接服务！');
      }
...
<div>
  <div id="connect-container">
    <input id="radio1" type="radio" name="group1" onclick="updateUrl('${baseHref.baseHref }websocket');">
    <label for="radio1">W3C WebSocket</label>
    <br>
    <input id="radio2" type="radio" name="group1" onclick="updateUrl('${baseHref.baseHref }sockjs/websocket');">
